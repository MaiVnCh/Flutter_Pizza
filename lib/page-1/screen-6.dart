      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              // groupoNj (6:12)
              margin: EdgeInsets.fromLTRB(31*fem, 0*fem, 35*fem, 41*fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
            ...
            Container(
              // imageG9q (0:170)
              margin: EdgeInsets.fromLTRB(28*fem, 0*fem, 29*fem, 31*fem),
              width: double.infinity,
              height: 363*fem,
              decoration: BoxDecoration (
            ...
            Container(
              // descriptionhkw (6:10)
              margin: EdgeInsets.fromLTRB(26*fem, 0*fem, 61*fem, 102*fem),
              width: double.infinity,
              child: Column(
