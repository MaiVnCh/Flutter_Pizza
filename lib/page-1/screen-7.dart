        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              // groupcYK (6:13)
              margin:
                  EdgeInsets.fromLTRB(31 * fem, 0 * fem, 28 * fem, 42 * fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
            ...
            Container(
              // deliverytoaX5 (6:15)
              margin:
                  EdgeInsets.fromLTRB(28 * fem, 0 * fem, 29 * fem, 49 * fem),
              width: double.infinity,
              child: Column(
            ...
            Container(
              // myorderR9d (6:27)
              margin:
                  EdgeInsets.fromLTRB(28 * fem, 0 * fem, 29 * fem, 54 * fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
            ...
            Container(
              // totalbcw (6:28)
              margin:
                  EdgeInsets.fromLTRB(31 * fem, 0 * fem, 26 * fem, 13 * fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
