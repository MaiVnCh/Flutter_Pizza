      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              // logo7JK (1:321)
              margin: EdgeInsets.fromLTRB(53.5*fem, 0*fem, 54.5*fem, 148*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(29.5*fem, 0*fem, 26.5*fem, 25*fem),
                    padding: EdgeInsets.fromLTRB(0.94*fem, 0.94*fem, 0.94*fem, 0.94*fem),
                    width: double.infinity,
                    height: 155*fem,
                    decoration: BoxDecoration (
                      color: Color(0xffffffff),
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration (
                        color: Color(0xffffffff),
                        borderRadius: BorderRadius.circular(76.5606079102*fem),
                      ),
                      child: Stack(
                        children: [
                          Positioned(
                            ...
                            child: Align(
                              child: SizedBox(
                                ...
                                child: Container(
                                  decoration: BoxDecoration (
                                    borderRadius: BorderRadius.circular(70.9242401123*fem),
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                        ...
                                        Positioned(
                                          ...
                                          child: Align(
                                            child: SizedBox(
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration (
                                                  borderRadius: BorderRadius.circular(5.3510746956*fem),
                                        ...
                                        Positioned(
                                          ...
                                          child: Align(
                                            child: SizedBox(
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration (
                                                  borderRadius: BorderRadius.circular(4.0221529007*fem),
                                                  color: Color(0xff3e1b0e),
                                                  boxShadow: [
                                                    BoxShadow(
                                                      color: Color(0x333e1b0e),
                                  ...
                                  Container(
                                    // ellipse3MZM (1:330)
                                    margin: EdgeInsets.fromLTRB(38.51*fem, 0*fem, 56.91*fem, 0*fem),
                                    width: double.infinity,
                                    height: 5.63*fem,
                                    decoration: BoxDecoration (
                                      borderRadius: BorderRadius.circular(2.8163552284*fem),
                                      color: Color(0xfff96a38),
                                      boxShadow: [
                                        BoxShadow(
                                          color: Color(0x333e1b0e),
